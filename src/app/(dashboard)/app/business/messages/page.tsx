export default function CustomerMessagesPage() {
  return (
    <div className="p-6 lg:p-8 max-w-5xl">
      <h1 className="text-2xl font-bold text-gray-900 mb-1">Customer Messages</h1>
      <p className="text-gray-500 mb-8">Respond to customer inquiries and booking questions.</p>
